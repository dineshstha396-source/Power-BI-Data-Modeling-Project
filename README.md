...
Keys follow consistent naming patterns such as:
...
The naming convention makes it easier to understand the role of fields and relationships without opening the underlying data.

Model Structure

The final semantic model contains separate dimensions and fact tables.
